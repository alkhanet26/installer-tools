...
1. Cara pasang Installer passwall lite
   ...
   ```
   wget --no-check-certificate "https://raw.githubusercontent.com/alkhanet26/installer-passwall-lite/main/inpass" -O /usr/bin/inpass && chmod chmod 777 /usr/bin/inpass
   ```
